...
if hasattr(sys, "pypy_version_info"):
    ...
    from __pypy__ import newlist_hint # type: ignore

    try:
        from __pypy__.builders import BytesBuilder as StringBuilder # type: ignore
    except ImportError:
        from __pypy__.builders import StringBuilder # type: ignore
