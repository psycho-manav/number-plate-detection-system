...
class TreeBuilder(base.TreeBuilder):
    ...
    def insertDoctype(self, token):
        ...
        if not name:
            warnings.warn("lxml cannot represent empty doctype",
                          DataLossWarning)
            self.doctype = None
        else:
            ...
            if coercedName != name:
                warnings.warn(
                    "lxml cannot represent non-xml doctype", DataLossWarning)
    ...
    def insertRoot(self, token):
        ...
        if self.doctype:
            ...
            if (self.doctype.publicId is not None or
                ...
                if self.doctype.systemId:
                    ...
                    if sysid.find("'") >= 0 and sysid.find('"') >= 0:
                        warnings.warn(
                            "DOCTYPE system cannot contain single and double quotes", DataLossWarning)
            ...
            if self.doctype.name != token["name"]:
                warnings.warn(
                    "lxml cannot represent doctype with a different name to the root element", DataLossWarning)
