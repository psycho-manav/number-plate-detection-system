...
class HTMLParser(object):
    ...
    def _parse(self, stream, innerHTML=False, container="div", scripting=False, **kwargs):
        ...
        self.tokenizer = _tokenizer.HTMLTokenizer(
            stream, parser=self, **kwargs)
        self.reset()
        ...
        for token in self.tokenizer:
            ...
            while new_token is not None:
                ...
                if type == ParseErrorToken:
                    self.parseError(new_token["data"],
                                    new_token.get("datavars", {}))
                    new_token = None
                else:
...
def getPhases(debug):
    ...
    class InHeadNoscriptPhase(Phase):
        ...
        startTagHandler = _utils.MethodDispatcher([
            ...
            (("basefont", "bgsound", "link", "meta",
             "noframes", "style"), startTagBaseLinkCommand),
    ...
    class InBodyPhase(Phase):
        ...
        def startTagFrameset(self, token):
            self.parser.parseError(
                "unexpected-start-tag", {"name": "frameset"})
        ...
        def startTagForm(self, token):
            if self.tree.formPointer:
                self.parser.parseError(
                    "unexpected-start-tag", {"name": "form"})
            else:
                if self.tree.elementInScope("p", variant="button"):
                    self.endTagP(impliedTagToken("p"))
                self.tree.insertElement(token)
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                # abort these steps.
                    ...
                    self.tree.activeFormattingElements.remove(
                        formattingElement)
                    return
